...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
        ...
        <section class="home-section home-full-height bg-dark-30" id="home" data-background="<?= base_url() ?>/Template/8/live/assets/images/section-5.jpg">
        ...
        <div class="main">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                            <div class="alt-services-image align-center"><img src="<?= base_url() ?>/Template/8/live/assets/images/promo.png" alt="Feature Image"></div>
                        </div>
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="alt-features-item">
            ...
            <section class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" data-background="<?= base_url() ?>/Template/8/live/assets/images/testimonial_bg.jpg">
