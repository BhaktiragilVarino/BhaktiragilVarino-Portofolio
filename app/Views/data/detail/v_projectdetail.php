...
<head>
    ...
    =============================================
    -->
    <link rel="apple-touch-icon" sizes="57x57" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>/Template/8/live/assets/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="<?= base_url() ?>/Template/8/live//manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?= base_url() ?>/Template/8/live/assets/images/favicons/ms-icon-144x144.png">
    ...
    -->
    <!-- Default stylesheets-->
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Template specific stylesheets-->
    <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Volkhov:400i" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/animate.css/animate.css" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/components-font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/et-line-font/et-line-font.css" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/flexslider/flexslider.css" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/owl.carousel/dist/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/owl.carousel/dist/assets/owl.theme.default.min.css" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/magnific-popup/dist/magnific-popup.css" rel="stylesheet">
    <link href="<?= base_url() ?>/Template/8/live/assets/lib/simple-text-rotator/simpletextrotator.css" rel="stylesheet">
    <!-- Main stylesheet and color file-->
    <link href="<?= base_url() ?>/Template/8/live/assets/css/style.css" rel="stylesheet">
    <link id="color-scheme" href="<?= base_url() ?>/Template/8/live/assets/css/colors/default.css" rel="stylesheet">
</head>
...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
        ...
        <div class="main">
            <section class="module bg-dark-60 portfolio-page-header" data-background="<?= base_url() ?>/Template/8/live/assets/images/portfolio/portfolio_header_bg.jpg">
                <div class="container">
                    <div class="row">
            ...
            <section class="module pb-0">
                ...
                <ul class="works-grid works-grid-gut works-hover-w works-grid-3" id="works-grid">
                    <li class="work-item illustration webdesign"><a href="portfolio_single_featured_image1.html">
                            <div class="work-image"><img src="<?= base_url() ?>/Template/8/live/assets/images/portfolio/grid-portfolio1.jpg" alt="Portfolio Item" /></div>
                    ...
                    <li class="work-item marketing photography"><a href="portfolio_single_featured_image2.html">
                            <div class="work-image"><img src="<?= base_url() ?>/Template/8/live/assets/images/portfolio/grid-portfolio2.jpg" alt="Portfolio Item" /></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item illustration photography"><a href="portfolio_single_featured_slider1.html">
                            <div class="work-image"><img src="<?= base_url() ?>/Template/8/live/assets/images/portfolio/grid-portfolio3.jpg" alt="Portfolio Item" /></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item marketing photography"><a href="portfolio_single_featured_slider2.htmll">
                            <div class="work-image"><img src="<?= base_url() ?>/Template/8/live/assets/images/portfolio/grid-portfolio4.jpg" alt="Portfolio Item" /></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item illustration webdesign"><a href="portfolio_single_featured_video1.html">
                            <div class="work-image"><img src="<?= base_url() ?>/Template/8/live/assets/images/portfolio/grid-portfolio5.jpg" alt="Portfolio Item" /></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item marketing webdesign"><a href="portfolio_single_featured_video2.html">
                            <div class="work-image"><img src="<?= base_url() ?>/Template/8/live/assets/images/portfolio/grid-portfolio6.jpg" alt="Portfolio Item" /></div>
                            <div class="work-caption font-alt">
                        ...
                        <div class="col-sm-3">
                            <div class="widget">
                                ...
                                <ul class="widget-posts">
                                    <li class="clearfix">
                                        <div class="widget-posts-image"><a href="#"><img src="<?= base_url() ?>/Template/8/live/assets/images/rp-1.jpg" alt="Post Thumbnail" /></a></div>
                                    ...
                                    <li class="clearfix">
                                        <div class="widget-posts-image"><a href="#"><img src="<?= base_url() ?>/Template/8/live/assets/images/rp-2.jpg" alt="Post Thumbnail" /></a></div>
                                        <div class="widget-posts-body">
    ...
    =============================================
    -->
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/jquery/dist/jquery.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/wow/dist/wow.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/jquery.mb.ytplayer/dist/jquery.mb.YTPlayer.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/isotope/dist/isotope.pkgd.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/imagesloaded/imagesloaded.pkgd.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/flexslider/jquery.flexslider.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/owl.carousel/dist/owl.carousel.min.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/smoothscroll.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/magnific-popup/dist/jquery.magnific-popup.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/lib/simple-text-rotator/jquery.simple-text-rotator.min.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/js/plugins.js"></script>
    <script src="<?= base_url() ?>/Template/8/live/assets/js/main.js"></script>
</body>
