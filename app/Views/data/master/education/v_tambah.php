                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xl-10">
                                    <div class="row align-items-center my-4">
                                        <div class="col">
                                            <h2 class="h3 mb-0 page-title">Add Education</h2>
                                        </div>
                                        <div class="col-auto">
                                            <a href="<?= base_url('education') ?>" class="btn btn-warning">Halaman Sebelumnya</a>
                                        </div>
                                    </div>
                                    <form action="<?= base_url('education/save'); ?>" method="POST" enctype="multipart/form-data">
                                        <hr class="my-4">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="nama_instansi_education" name="nama_instansi_education" class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="logo_instansi_education">Foto Logo</label>
                                                <input type="file" accept="images/*" id="logo_instansi_education" name="logo_instansi_education" class="form-control">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="prodi_education">Program Studi Instansi</label>
                                                <input type="text" id="prodi_education" name="prodi_education" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label for="keterangan_education">Keterangan</label>
                                                <textarea class="form-control" name="keterangan_education" id="keterangan_education" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                        <hr class="my-4">
                                        <div class="form-row">
