                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="w-50 mx-auto text-center justify-content-center py-5 my-5">
                                        <h2 class="page-title mb-0">Pengecekan Data Home ?</h2>
                                        <?php if ($home) : ?>
                                            <p class="lead text-muted mb-3 mt-2">Anda Sudah Mempunyai Data Di Home Silakan Cek Sekarang .</p>
                                            <a href="<?= base_url('home/edit/1') ?>" class="form-control form-control-lg bg-warning rounded-pill">Cek Data</a>
                                        ...
                                        <?php else : ?>
                                            <p class="lead text-muted mb-3 mt-2">Anda Belum Mempunyai Data Di Home.</p>
                                            <a href="<?= base_url('home/tambah') ?>" class="form-control form-control-lg bg-warning rounded-pill">Tambah Data</a>
