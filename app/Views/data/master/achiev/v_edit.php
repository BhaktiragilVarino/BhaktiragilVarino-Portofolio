        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="<?= base_url('achiev/update/' . $achiev['id_achiev'])  ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="nama_achiev">Nama Achievment</label>
                            <input type="text" class="form-control" id="nama_achiev" value="<?= $achiev['nama_achiev']; ?>" name="nama_achiev" placeholder="Masukan Nama Achievment ">
                        </div>
                        <div class="form-group">
                            <label for="foto_achiev">Foto</label>
                            <p class="text-info">* Direkomendasikan Menggunakan Foto 230px * 190px</p>
                            <input type="file" accept="images/*" class="form-control" id="foto_achiev" value="<?= $achiev['foto_achiev']; ?>" name="foto_achiev" placeholder="Masukan Foto">
                        </div>
