    ...
    <section class="banner-area" id="home">
        <div class="container">
            <div class="row fullscreen d-flex align-items-center justify-content-start">
                ...
                $query = $db->table('home')->get();
                $home = $query->getResult();
                ...
                foreach ($home as $row) { ?>
                    ...
                    <div class="col-lg-12 banner-content" style="color: #721D7A; ">
                        ...
                        <div class="col-lg-12 d-flex minat" style="margin-left: -15px;">
                            <h3 class="text-uppercase" style="margin-top: -15px; font-family: 'MyCustomFont2'; color: #B4007B; font-size: 20px;"><?= $row->minat_home ?></h3>
                        </div>

                        <?php
                        $files = explode(',', $row->cv_home);
                        ?>

                        <a id="animationContainer" href="<?= base_url('upload_file') ?>/<?= trim($files[0]) ?>" class="genric-btn primary circle text-uppercase mt-4" style="background-color: #D80400;">
                        ...
                        <?php if (isset($files[1])): ?>
                            <a id="animationContainer2" href="<?= base_url('upload_file') ?>/<?= trim($files[1]) ?>" class="genric-btn primary-border circle text-uppercase mt-4 ml-3">
                                <div style="display: flex; margin-left:-20 ;">
                                    <div id="cv2">
                                        <span>CV</span>
                                    </div>
